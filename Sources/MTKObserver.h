...
typedef void(^MTKBlockGeneric)            (__weak id selfInstance, id newValue);
typedef void(^MTKBlockChange)             (__weak id selfInstance, id oldValue, id newValue);
typedef void(^MTKBlockChangeMany)         (__weak id selfInstance, NSString *keyPath, id oldValue, id newValue);
typedef void(^MTKBlockInsert)             (__weak id selfInstance, id newValue, NSIndexSet *indexes);
typedef void(^MTKBlockRemove)             (__weak id selfInstance, id oldValue, NSIndexSet *indexes);
typedef void(^MTKBlockReplace)            (__weak id selfInstance, id oldValue, id newValue, NSIndexSet *indexes);

typedef void(^MTKBlockForeignChange)      (__weak id selfInstance, __weak id object, id oldValue, id newValue);
typedef void(^MTKBlockForeignChangeMany)  (__weak id selfInstance, __weak id object, NSString *keyPath, id oldValue, id newValue);

typedef void(^MTKBlockNotify)             (__weak id selfInstance, NSNotification *notification);
